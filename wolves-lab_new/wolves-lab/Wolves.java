...
public class Wolves {
    ...
    private void initWolves() {
        ...
        for (int i = 0; i < numWolves; i++) {
            wolvesPool[i] = new GreedyWolf();
        }
        // wolvesPool[0] = new SimpleCoordinatedWolf();
        // wolvesPool[1] = new CoordinatedWolf();
        // wolvesPool[2] = new SimpleCoordinatedWolf();
        // wolvesPool[3] = new CoordinatedWolf();
        // wolvesPool[4] = new RandomWolf(); // Keep one random wolf for comparison
